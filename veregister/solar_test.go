...
func TestAppendSolar(t *testing.T) {
	...
	expected := []string{
		...
		"Number: category=Essential, name=LoadCurrent, description=Load Current, sort=10, address=0xEDAD, static=false, writable=false, signed=false, factor=10, offset=0.000000, unit=A",
		"Enum: category=Essential, name=LoadOutputState, description=Load Output State, sort=11, address=0xEDA8, static=false, writable=false, enum=map[0:Off 1:On]",
		...
		"Number: category=Load, name=LoadOffsetVoltage, description=Load Offset Voltage, sort=500, address=0xEDAC, static=false, writable=false, signed=false, factor=100, offset=0.000000, unit=V",
		"Number: category=Load, name=LoadOutputVoltage, description=Load Output Voltage, sort=501, address=0xEDA9, static=false, writable=false, signed=false, factor=100, offset=0.000000, unit=V",
		"Number: category=Load, name=LoadSwitchHighLevel, description=Load Switch High Level, sort=502, address=0xED9D, static=false, writable=false, signed=false, factor=100, offset=0.000000, unit=v",
		"Number: category=Load, name=LoadSwitchLowLevel, description=Load Switch Low Level, sort=503, address=0xED9C, static=false, writable=false, signed=false, factor=100, offset=0.000000, unit=v",
