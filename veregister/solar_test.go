...
func TestAppendSolar(t *testing.T) {
	...
	expected := []string{
		...
		"Enum: category=Settings, name=AdaptiveMode, description=Adaptive mode, sort=500, address=0xEDFE, static=true, writable=false, enum=map[0:Off 1:On]",
		...
		"Enum: category=Settings, name=BatteryType, description=Battery type, sort=507, address=0xEDF1, static=false, writable=false, enum=map[1:Gel Victron Long Life (14.1V) 2:Gel Victron Deep discharge (14.3V) 3:Gel Victron Deep discharge (14.4V) 4:AGM Victron Deep discharge (14.7V) 5:Tubular plate cyclic mode 1 (14.9V) 6:Tubular plate cyclic mode 2 (15.1V) 7:Tubular plate cyclic mode 3 (15.3V) 8:LiFEPO4 (14.2V) 255:User defined]",
		...
		"Enum: category=Settings, name=BatteryVoltageSetting, description=Battery voltage setting, sort=511, address=0xEDEA, static=false, writable=false, enum=map[0:Auto detection at startup 12:12V battery 24:24V battery 36:36V battery 48:48V battery]",
		"Enum: category=Settings, name=BmsPresent, description=BMS present, sort=512, address=0xEDE8, static=false, writable=false, enum=map[0:No 1:Yes]",
		...
		"Enum: category=Settings, name=AutoEqualiseStop, description=Auto equalise stop on voltage, sort=515, address=0xEDE5, static=false, writable=false, enum=map[0:No 1:Yes]",
